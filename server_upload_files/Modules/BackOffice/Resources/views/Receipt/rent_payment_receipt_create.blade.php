        ...
        if(contractId == ''){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    var firstCheque = $('#pdc_replace_cheque option:selected').data('cheque');
                    $('#receipts_generation_remark').val('Received cash payment for cheque no ' + (firstCheque || ''));
                }
            });
        }
...
$(document).on('change', '#pdc_replace_cheque', function(){
    var chequeNo = $(this).find('option:selected').data('cheque');
    $('#receipts_generation_remark').val('Received cash payment for cheque no ' + (chequeNo || ''));
});
