...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Update Contract</div>
        </div>
...
<div class="card card-box salesSearchBox">
 <form action="{{route('landlordRenewalContractUpdate',$landlordContract->id)}}" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
  {{csrf_field()}} 
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group ">
                   ...
                   <input type="text"  class="form-control" id="landlord_contract_old_no" name="landlord_contract_old_no" value="{{$landlordContract->landlord_contract_old_no}}" required readonly>
               </div>
                </div>
            </div>
            <div class="col-sm-4">
