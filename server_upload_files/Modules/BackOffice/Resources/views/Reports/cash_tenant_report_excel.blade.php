...
<table>
  <thead>
    <tr>
      <th colspan="12" style="font-weight:bold;font-size:14px">Cash Tenant Report</th>
    </tr>
    <tr>
      <td colspan="12">Active tenant contracts with no post dated cheque on record. Total: {{ $total }}</td>
    </tr>
    <tr>
      <td colspan="12">Generated {{ date('d/m/Y H:i') }}@isset($user) by {{ $user->username }}@endisset</td>
    </tr>
    ...
    <tr>
      ...
      <th style="font-weight:bold">ARE</th>
      ...
      <th style="font-weight:bold">Paid Up To</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>{{ $row->paid_up_to ? \Carbon\Carbon::parse($row->paid_up_to)->format('d/m/Y') : '' }}</td>
