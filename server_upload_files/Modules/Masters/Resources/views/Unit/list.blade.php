              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    <tr>
                        ...
                        {{-- Status is unit_status; this used to repeat the Vacant
                             column's unit_vaccant_status, so it sorted the wrong data --}}
                        <th>@sortablelink('unit_status','Status',[], ['class' => 'sort_class'])</th>
                         @endcan
                        <th>Action</th>
                    </tr>
                    <tr>
...
<script>
 ...
 // jQuery('.dataTables_length').addClass('bs-select');
       ...
       $(document).on('change keyup paste','.search_fields',function(){ 
         ...
         // Carry the column the user is sorting by into the search request.
         // Without these the filtered result came back unsorted, so searching
         // looked like it silently reset the sort.
