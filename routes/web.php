...
Route::get('averageReceivableUnit','DashboardController@averageReceivableUnit')->name('averageReceivableUnit');
   ...
   Route::post('collectionMTD','DashboardController@collectionMTD')->name('collectionMTD'); 
   Route::post('tenant_vacating','DashboardController@tenantVacating')->name('tenant_vacating'); 
   ...
   Route::post('tenant_are','DashboardController@tenantAre')->name('tenant_are'); 
   Route::any('lawyerApprovalMd/{type?}','DashboardController@lawyerApproval')->name('lawyerApprovalMd'); 
   Route::any('plmsApprovalMd/{type?}','DashboardController@plmsApproval')->name('plmsApprovalMd'); 
   Route::any('renewedContractMd','DashboardController@renewedContractMd')->name('renewedContractMd'); 
   Route::post('vacantUnitMov','DashboardController@vacantUnitMov')->name('vacantUnitMov'); 
   Route::any('tenantRedirect/{user_id?}','DashboardController@tenantRedirect')->name('tenantRedirect'); 
   //Route::post('vacantUnitMovementSc','DashboardController@getVacantUnitMovementSchedule')->name('vacantUnitMovementSc'); 
   Route::post('getVacantUnitsLoc','DashboardController@getVacantUnitsLoc')->name('vacantUnitsLoc'); 
    ...
    Route::get('vacatedUnitsMTDList/{are?}','MD_DashboardController@vacatedUnitsMTDList')->name('vacatedUnitsMTDList');
    ...
    Route::get('plmsApproval', 'DashboardController@plmsApproval')->name('plmsApproval');
