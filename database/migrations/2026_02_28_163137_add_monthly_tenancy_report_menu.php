...
class AddMonthlyTenancyReportMenu extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $menuId = DB::table('menu')->insertGetId([
            'menu_name'   => 'Monthly Tenancy Details',
            'menu_icon'   => 'fa-building',
            'route_name'  => 'showMonthlyTenancyReport',
            'url_key'     => 'showMonthlyTenancyReport',
        ...
        DB::table('permissions')->insert([
            'name'       => 'view_monthly_tenancy_report',
            'guard_name' => 'web',
            'menu_id'    => $menuId,
            'created_at' => now(),
            'updated_at' => now(),
        ...
        $permission = DB::table('permissions')
            ->where('name', 'view_monthly_tenancy_report')
            ->first();
    ...
    {
        $menu = DB::table('menu')
            ->where('route_name', 'showMonthlyTenancyReport')
            ->first();
