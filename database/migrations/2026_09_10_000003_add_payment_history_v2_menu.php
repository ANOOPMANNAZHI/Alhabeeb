...
/**
 * Adds the Payment History V2 report under PLM Module -> Reports, with its view
 ...
 */
class AddPaymentHistoryV2Menu extends Migration
{
    const ROUTE = 'showPaymentHistoryReportV2';
    const PERMISSION = 'view_payment_history_v2';
    ...
    public function up()
    {
        ...
        $menuId = DB::table('menu')->insertGetId([
            'menu_name'   => "Tenant's Payment History - Agreement Wise (V2)",
