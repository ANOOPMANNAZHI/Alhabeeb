...
class AddLeasingConsultantPerformanceMenu extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $menuId = DB::table('menu')->insertGetId([
            'menu_name'   => 'Leasing Consultant Performance',
            'menu_icon'   => 'fa-bar-chart',
            'route_name'  => 'showLeasingConsultantPerformance',
            'url_key'     => 'showLeasingConsultantPerformance',
        ...
        DB::table('permissions')->insert([
            'name'       => 'leasing_consultant_performance',
            'guard_name' => 'web',
            'menu_id'    => $menuId,
            'created_at' => now(),
            'updated_at' => now(),
        ...
        $permission = DB::table('permissions')
            ->where('name', 'leasing_consultant_performance')
            ->first();
    ...
    {
        $menu = DB::table('menu')
            ->where('route_name', 'showLeasingConsultantPerformance')
            ->first();
