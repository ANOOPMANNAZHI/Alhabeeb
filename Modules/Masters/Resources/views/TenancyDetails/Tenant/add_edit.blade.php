                ...
                <i class="icon icon-tenant" aria-hidden="true"></i>
                  ...
                  <option value=""> Select Tenant Type </option>
                    @foreach($tenantTypes as $tenantType)
                     <option  {{(old('tenant_type_id', isset($tenant)?  $tenant->tenant_type_id : 7) == $tenantType->id) ? 'selected' : '' }} value="{{$tenantType->id}}">{{$tenantType->tenant_types_name}}</option>
                    @endforeach                  
                </select> 
                </div>               
            </div>
       ...
       <div class="row" id="row_ind" style="display: none">
          ...
          <div class="col-sm-6">
            <div class="form-group">
               ...
               <div class="error2" style="display:none">Residence ID No Already Exist in this System !</div>
            </div>
          </div>
          <div class="col-sm-6">
            <div class="form-group">
                <label for="tenant_resident_exp_date">Residence ID Exp Date</label>
                 <div class="p-relative">
                <i class="fa fa-address-card-o icn-add" aria-hidden="true"></i>
                <input  type="date" class="form-control" id="tenant_resident_exp_date"  placeholder="Enter Resident Id" name="tenant_resident_exp_date" value="{{ isset($tenant)?  old('tenant_resident_exp_date',$tenant->tenant_resident_exp_date): old('tenant_resident_exp_date')}}">
              </div>
            </div>
          </div>
          <div class="w-100"></div>
       ...
       <!--  <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              ...
              <div class="error3" style="display:none">Commercial Reg. No Already Exist in this System !</div>
            </div>
          </div>
           <div class="col-sm-6">
          <div class="form-group">
      ...
      <div class="row">
        ...
        <div class="w-100"></div>
		 <div class="col-sm-6">
          <div class="form-group">
              ...
              <input  type="text" required class="form-control" id="tenant_contact_no"  pattern="^((\+)?(\d{2,3}))?(\d{8}){1}?$"  placeholder="Enter Mobile No" name="tenant_contact_no" value="{{ isset($tenant)?  old('tenant_contact_no',$tenant->tenant_contact_no): old('tenant_contact_no')}}">
            </div>
             <div class="error1" style="display:none">Mobile No Already Exist in this System !</div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
              <label for="gsm_no">Office No</label>
               <div class="p-relative">
                <i class="fa fa-list-ol icn-add" aria-hidden="true"></i>
              <input  type="text" class="form-control" id="gsm_no"  pattern="^((\+)?(\d{2,3}))?(\d{8}){1}?$"  placeholder="Enter Office No" name="gsm_no" value="{{ isset($tenant)?  old('gsm_no',trim($tenant->gsm_no)): old('gsm_no')}}">
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="p-relative">
                <i class="fa fa-volume-control-phone icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control" id="tenant_residence_tel"   placeholder="Enter Residence Tel" name="tenant_residence_tel" value="{{ isset($tenant)?  old('tenant_residence_tel',$tenant->tenant_residence_tel): old('tenant_residence_tel')}}" >
              </div>
            </div>
          </div>
        <div class="w-100"></div>
         <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="p-relative">
                <i class="fa fa-volume-control-phone icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control" id="tenant_personal_email"   placeholder="Enter Personal Email" name="tenant_personal_email" value="{{ isset($tenant)?  old('tenant_personal_email',$tenant->tenant_personal_email): old('tenant_personal_email')}}">
              </div>
            </div>
          </div>
         <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-sm-5">
            <div class="form-group">
                ...
                <select class="form-control" id="tenant_doc_category"  name="tenant_doc_category[]" >
           ...
           <div class="col-sm-5">
            <div class="form-group">
                ...
                <input type="file" class="form-control"  id="tenant_doc_path_name"  name="tenant_doc_path_name[]" data-rule-extension="jpeg|jpg|docx|pdf|doc" data-msg-extension="Only allows jpeg|jpg|docx and doc">
            </div>
            </div>
          </div>
          <div class="col-sm-2">
...
/********************************Add Image multiple*************************************/    
    ...
    var fieldDocHTML = '<div class="row ro"><div class="col-sm-5"><div class="form-group"><label for="tenant_doc_category"></label><div class="p-relative"><i class="fa fa-anchor icn-add" aria-hidden="true"></i><select class="form-control margin-top-8" id="tenant_doc_category"  name="tenant_doc_category[]" ><option value="">Select </option><option value="0">Resident Card</option><option value="1">Passport</option><option value="2">CR</option><option value="3">Others</option></select></div></div></div><div class="col-sm-5"><div class="form-group"><label for="building_doc_path_name"></label><div class="p-relative"><i class="fa fa-paperclip icn-add" aria-hidden="true"></i><input type="file" class="form-control"  id="tenant_doc_path_name"  name="tenant_doc_path_name[]" data-rule-extension="jpeg|jpg|docx|pdf|doc" data-msg-extension="Only allows jpeg|jpg|docx and doc"></div></div></div><div class="col-sm-2"><div class="dataSearchLabel w-100" style="margin-top: 36px"></div><button title="Delete" type="button" class="btn btn-warning remove_doc_button"><i class="fa fa-trash-o "></i></button></div></div>'; //New input field html 
    ...
    $(addDocButton).click(function(){
        ...
        if(x < maxField){ 
            ...
            $(wrapperDoc).append(fieldDocHTML); //Add field html
        }
    });
