...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
           ...
           {{ Breadcrumbs::render('legaltenantContractShow',$tenantContract) }} 
    </div>
</div>
        ...
        <div class="card card-box salesSearchBox">
            ...
            <div class="dataSearchBox">    
                <div class="card-body row">
                    ...
                    <div class="col-lg-6 p-t-20"> 
                        <div class = "txt-full-width">
                            <h5 class="details"><b>Unit Usage :  </b><span>{{$tenantContract->unit_usage?? "NA"}}</span></h5>
                        </div>
                    </div>
                    <div class="col-lg-6 p-t-20"> 
                        <div class = "txt-full-width">
                            <h5 class="details"><b>Occupant Name :  </b><span>{{$tenantContract->occupant->occupant_name?? "NA"}}</span></h5>
                        </div>
                    </div> 
                    <div class="col-lg-6 p-t-20"> 
                        <div class = "txt-full-width">
            ...
            <div class="dataSearchBox">    
                <div class="card-body row">
                    ...
                    <div class="col-lg-6 p-t-20"> 
                        <div class = "txt-full-width">
                            <h5 class="details"><b>Vacant Since :  </b><span>{{isset($tenantContract->vaccant_date)?$tenantContract->vaccant_date->format('d/m/Y'):"NA"}} </span></h5>
                        </div>
                    </div>
                    <div class="col-lg-6 p-t-20"> 
                        <div class = "txt-full-width">
