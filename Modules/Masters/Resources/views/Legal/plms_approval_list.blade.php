...
@endsection
   ...
   @section('search_url', route('plmsApproval')) 
 @section('search_reset', route('plmsApproval')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Legal Cases for Approval</div>
        </div>
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    ...
                    <tr>
                        ...
                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('plmsApprovalSearch')}}" ></td>
                    </tr>
                </thead>
                <tbody id="enquiry-search">
                                                               
                    @include('masters::Legal.plms_approval_list_ajax')  
                                                            
                </tbody>
                </table>
                        
                 <div class="row "  id="pagination">                                
                     {{$plmsApprovals->appends(\Request::except(['page','_token']))->links()}} 
                </div> 
