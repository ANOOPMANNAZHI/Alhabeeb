...
@endsection
 ...
 @section('search_url', route('referBackCases')) 
 @section('search_reset', route('referBackCases')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Referback Legal Cases</div>
        </div>
             ...
             <div class="clr"></div>
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                ...
                <tbody id="enquiry-search">
                    ...
                    @include('masters::Legal.referback_cases_list_ajax')  
