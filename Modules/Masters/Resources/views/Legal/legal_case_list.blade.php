...
@endsection
   ...
   @section('search_url', route('legalCase.index')) 
 @section('search_reset', route('legalCase.index')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Legal Case List</div>
        </div>
       {{ Breadcrumbs::render('legalCase.index') }}
    </div>
</div>
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    <tr>
                        ...
                        <th>@sortablelink('tenant_tenant_name','Name',[],[ 'class' => 'sort_url'])</th>
                        ...
                        <th>@sortablelink('workFlowProcess.work_flow_processes_name','Legal Status',[],[ 'class' => 'sort_url'])</th>
                        <th>Action</th>
                    </tr>
                    <tr>
                        ...
                        <td><input autocomplete="off" type="text" name="work_flow_processes_id" class="search_fields mob" id="work_flow_processes_id"  value="{{old('workFlowProcess__work_flow_processes_name')}}" ></td>
                        ...
                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('legalCaseSearch')}}" ></td>
                    </tr>
                </thead>
                <tbody id="enquiry-search">
                                                               
                    @include('masters::Legal.legal_case_list_ajax')  
                                                            
                </tbody>
                </table>
                        
                 <div class="row "  id="pagination">                                    
                     {{$legalCases->appends(\Request::except(['page','_token']))->links()}}
                </div> 
