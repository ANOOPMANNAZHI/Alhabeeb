...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Closed Legal Case Details</div>
    </div>

    {{ Breadcrumbs::render('closedLegalCases',$closedLegalCase) }}
...
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
      ...
      <div class="dataSearchBox">    
        <div class="card-body row">
          ...
          @if(isset($closedLegalCase->building_id))
          <div class="col-lg-6 p-t-20"> 
            <div class = "txt-full-width">
             <h5 class="details"><b>Building Name :  </b><span>{{$closedLegalCase->building->building_name}}</span></h5>
           </div>
         </div> 
         @endif
         @if(isset($closedLegalCase->building_id))
         <div class="col-lg-6 p-t-20"> 
          <div class = "txt-full-width">
           <h5 class="details"><b>Building Code :  </b><span>{{$closedLegalCase->building->building_code}}</span></h5>
         </div>
       </div>
       @endif
       @if(isset($closedLegalCase->building_id))
       <div class="col-lg-6 p-t-20"> 
        <div class = "txt-full-width">
         <h5 class="details"><b>Landlord :  </b><span>{{$closedLegalCase->building->vendor->vendor_name}}</span></h5>
       </div>
     </div>
     @endif
     @if(isset($closedLegalCase->building_id))
     <div class="col-lg-6 p-t-20"> 
      <div class = "txt-full-width">
       <h5 class="details"><b>ARE :  </b><span>{{$closedLegalCase->building->vendor->vendor_name}}</span></h5>
     </div>
   </div>
   @endif
   @if(isset($closedLegalCase->building_id))
   <div class="col-lg-6 p-t-20"> 
    <div class = "txt-full-width">
     <h5 class="details"><b>Way No :  </b><span>{{$closedLegalCase->building->plot_no}}</span></h5>
   </div>
 </div>
 @endif
 @if(isset($closedLegalCase->building_id))
 <div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Block No :  </b><span>{{$closedLegalCase->building->block_number}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->building_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Plot No :  </b><span>{{$closedLegalCase->building->plot_no}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->building_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Location :  </b><span>{{$closedLegalCase->building->location->locations_name}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->building_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Location No :  </b><span>{{$closedLegalCase->building->location->locations_code}}</span></h5>
 </div>
</div>
@endif
</div>
...
<div class="dataSearchBox">    
  <div class="card-body row">
    @if(isset($closedLegalCase->unit_id))
    <div class="col-lg-6 p-t-20"> 
      <div class = "txt-full-width">
       <h5 class="details"><b>Unit No :  </b><span>{{$closedLegalCase->unit->unit_no}}</span></h5>
     </div>
   </div>
   @endif
   @if(isset($closedLegalCase->unit_id))
   <div class="col-lg-6 p-t-20"> 
    <div class = "txt-full-width">
     <h5 class="details"><b>Unit Type :  </b><span>{{$closedLegalCase->unit->unit->unit_types_name}}</span></h5>
   </div>
 </div>
 @endif
 @if(isset($closedLegalCase->unit_id))
 <div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Floor No :  </b><span>{{$closedLegalCase->unit->unit_floor}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->tenantContract->unit_usage))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Unit Usage :  </b><span>{{$closedLegalCase->tenantContract->unit_usage}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->tenantContract->tenant_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Tenant Name :  </b><span>{{$closedLegalCase->tenantContract->tenant->tenant_name}}</span></h5>
 </div>
</div> 
@endif
@if(isset($closedLegalCase->tenantContract->tenant_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Tenant Code :  </b><span>{{$closedLegalCase->tenantContract->tenant->tenant_code}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->tenantContract->occupant_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Occupant Name :  </b><span>{{$closedLegalCase->tenantContract->occupant->occupant_name}}</span></h5>
 </div>
</div> 
@endif
@if(isset($closedLegalCase->tenantContract->occupant_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Occupant Mob No :  </b><span>{{$closedLegalCase->tenantContract->occupant->occupant_primary_contact_no}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->tenantContract->occupant_id))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Occupant Email :  </b><span>{{$closedLegalCase->tenantContract->occupant->occupant_email}}</span></h5>
 </div>
</div> 
@endif
</div>
...
<div class="dataSearchBox">    
  <div class="card-body row">
    ...
    @if(isset($closedLegalCase->tenantContract->tenant_contract_start_date))
    <div class="col-lg-6 p-t-20"> 
      <div class = "txt-full-width">
       <h5 class="details"><b>Start Date :  </b><span>{{$closedLegalCase->tenantContract->tenant_contract_start_date->format('d/m/Y')}}</span></h5>
     </div>
   </div> 
   @endif
   @if(isset($closedLegalCase->tenantContract->tenant_contract_effective_date))
   <div class="col-lg-6 p-t-20"> 
    <div class = "txt-full-width">
     <h5 class="details"><b>Effective Date :  </b><span>{{$closedLegalCase->tenantContract->tenant_contract_effective_date->format('d/m/Y')}}</span></h5>
   </div>
 </div>
 @endif 
 @if(isset($closedLegalCase->tenantContract->tenant_contract_valid_to_date))
 <div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>End Date :  </b><span>{{$closedLegalCase->tenantContract->tenant_contract_valid_to_date->format('d/m/Y')}}</span></h5>
 </div>
</div>
@endif
@if(isset($closedLegalCase->tenantContract->tenant_contract_value))
<div class="col-lg-6 p-t-20"> 
  <div class = "txt-full-width">
   <h5 class="details"><b>Contract Value :  </b><span>{{ numberFormat($closedLegalCase->tenantContract->tenant_contract_value) }} OMR</span></h5>
 </div>
</div> 
@endif
<div class="col-lg-6 p-t-20"> 
...
<div class="card card-box salesLeadBox">
  <div class="card-head">
       ...
       <div class="col-sm-6">
        <div class="form-group">
          ...
          <div class="p-relative">
            ...
            <input type="hidden" name="legal_id" value="{{$closedLegalCase->id}}">
    ...
    <div class="field_wrapper">
      @if(!empty($closedLegalCase->legalDocument)) 
      @foreach ($closedLegalCase->legalDocument  as $doc) 
      <div class="row ro ">
       <div class="col-sm-6">
