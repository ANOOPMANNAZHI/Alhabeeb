...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Report on Vacant Unit</div>
    </div>
    {{ Breadcrumbs::render('showVacantUnitReport') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
       @can('view_vacant_unit') 
      <form action="{{route('vacantUnitReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}} 
        <div class="dataSearchBox ">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="tenant_contract_valid_to_date">As On Date<small class="textRed">*</small></label>
                <div class="p-relative">
                  <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="p-relative">
                  ...
                  <select class="form-control" name="management_types_name">
                    <option value="">Select Management Type</option>
                    <option value="">All Management Type</option>
                    @foreach($managementTypes as $managementType)
                    <option value="{{$managementType->management_types_name}}">{{$managementType->management_types_name}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
