...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        ...
        {{Breadcrumbs::render('landlord-contract.create')}}
    </div>
</div>
<div class="row">
<div class="col">
<div class="card card-box salesSearchBox">
 <form action="{{route('landlord-contract.store')}}" autocomplete="off" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
    {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input  type="date" class="form-control" id="simpleFormEmail" placeholder="{{today()->format('Y-m-d') }}" value="{{ isset($enquiry)? $enquiry->created_at->format('Y-m-d') : today()->format('Y-m-d') }}" name="agreement_date">
                </div>
                </div>
            </div>
...
<div class="sub-head">Landlord Details 
    @can('add_vendor')
        ...
        <div class="col-sm-6">
            <div class="form-group">
               ...
               <div class="p-relative">
                    ...
                    <input type="text" placeholder="Select Landlord Name First" required name="building_name" class="form-control building_name building" id="building_name" value="" readonly>
...
<div class="dataSearchBox sub-box ">
        ...
        <div class="col-sm-6" id="comprehensive_field" style="display:none;">
            <div class="form-group">
                ...
                <div class="p-relative">
                    <i class="fa fa-money icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control allownumericwithdecimal" id="landlord_contract_amt"  placeholder="Enter Amount" name="landlord_contract_amt" value="{{ isset($data)?  old('vendor_contact_no',numberFormat($data->vendor_contact_no)): old('vendor_contact_no')}}"  maxlength="12">
                  </div>               
            </div>
        </div>
        ...
        <div class="col-sm-6 percentage_field_value" style="display:none;">
            <div class="form-group">
                 ...
                 <div class="p-relative">
                    <i class="fa fa-money icn-add" aria-hidden="true"></i>
                    <input type="number" class="form-control" id="landlord_contract_management_fee" name="landlord_contract_management_fee" placeholder="Enter Management Value" min="1" max="999999999" required>
            </div>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="landlord_free_lease_period">Free Lease Period</label>
                 <div class="p-relative">
                    <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
                <input type="text" name="landlord_free_lease_period" class="form-control" onkeypress="return isNumber(event)" id="landlord_free_lease_period" placeholder="Enter Free Lease Period">
            </div>
            </div>
        </div>
        <div class="w-100"></div>
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label for="landlord_contract_valid_from_date">Valid From<small class="textRed">*</small></label>
                 <div class="p-relative">
                    <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
                <input type="date" class="form-control" required id="landlord_contract_valid_from_date" name="landlord_contract_valid_from_date" placeholder="Enter Valid From">
            </div>
            </div>
        </div>
                ...
                <label for="landlord_marketing_executive">Marketing Executive Name</label>
                 ...
                 <select class="form-control" name="landlord_marketing_executive" >
                    ...
                    @foreach($salesTeam as $sal)
                        <option value="{{$sal->employee->id}}">{{$sal->employee->employee_name.'('.$sal->employee->employee_code.')'}}</option>
                    @endforeach
                </select>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $('#management_id').on('change', function(e) {  
        ...
        if(management_id == 1){
            ...
            $(".percentage_field_value").hide();
            $("#landlord_contract_amt").attr('required','required');
			$("#duration_type option:eq(1)").prop("disabled", "true");
            $('#duration_type').val('');
            $("#comprehensive_field").show();
        }   
        else{
...
$('#vendor_name').autocomplete({
      ...
      change:function(e,ui){
        if (ui.item == null || ui.item == undefined) {
                ...
                $('#building_name').prop("readOnly", false).attr("placeholder", "Enter Building name");     
                @can('add_building') $('#create_build_span').show(); @endcan      
           }
