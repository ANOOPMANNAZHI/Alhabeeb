...
@section('search_url', route('depositRefund.index')) 
@section('search_reset', route('depositRefund.index')) 
...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Deposit Refund</div>
    </div>
    {{ Breadcrumbs::render('depositRefund.index') }}
  </div>
</div>
...
<div class="row">
  ...
  <div class="card  card-box">
    ...
    <div class="card-body ">
      ...
      <div id="pagination_info">
        ...
        @can('deposit_refund_add')

        <a href="{{route('depositRefund.create')}}" class="btn btn-circle btn-primary  align-right"  >Add</a>  
        @endcan
        <div class="clr"></div>
      </h4>
 ...
 <div class="table-responsive">	
        <table class="table display product-overview mb-30" id="dtBasicExample">
          <thead>
            ...
            <tr>
              ...
              <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('depositRefundSearch')}}" ></td>
              <td></td>
            </tr>
          </thead>
          <tbody id="enquiry-search">

            @include('backoffice::Transaction.deposit_refund_list_ajax')  
      ...
      <div class="row "  id="pagination">                  
        {{$depositRefunds->appends(\Request::except(['page','_token','ajax']))->links()}} 
      </div> 
