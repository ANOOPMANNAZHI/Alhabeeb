...
@section('search_url', route('maintenancePaymentApproval')) 
@section('search_reset', route('maintenancePaymentApproval')) 
...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Maintenance Payment Approval</div>
    </div>
    {{ Breadcrumbs::render('maintenancePaymentApproval') }}
  </div>
</div>
...
<div class="row">
 ...
 <div class="table-responsive">	
      <table class="table display product-overview mb-30" id="dtBasicExample">
        <thead>
          <tr>
            ...
            <th>@sortablelink('maintenance_payment_date','Payment Dt',[],[ 'class' => 'sort_url' ])</th>
            ...
            <th>@sortablelink('maintenance_payment_approval_status','Purpose',[],[ 'class' => 'sort_url' ])</th>
            <th>Action</th>
          </tr>
          <tr>
            <td></td>
          ...
          <td>
            <select name="maintenance_payment_approval_status" class="searchFields search_fields mob" id="maintenance_payment_approval_status" style="width:100px;">
              <option value="">Show All</option>
              <option {{ (old('maintenance_payment_approval_status') == 2)? 'selected' : '' }} value="2">{{'Approval'}}</option>
              <option {{ (old('maintenance_payment_approval_status') == 3)? 'selected' : '' }} value="3">{{'UnApproval'}}</option>
            </select>
          </td>

          <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('paymentApprovalSearch')}}" ></td>
          <td></td>
        </tr>
      </thead>
      <tbody id="enquiry-search">

        @include('backoffice::Transaction.maintenance_payment_approval_list_ajax')  
  ...
  {{$maintenancePaymentApprovals->appends(\Request::except(['page','_token','ajax']))->links()}} 
</div> 
