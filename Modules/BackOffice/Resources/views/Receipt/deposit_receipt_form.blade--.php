                  ...
                  if(result[0].tenant_contract_no){
                   ...
                   // $('#tenant_contract_no').html('<option value="">Select Agreement No</option>');
                        ...
                        $('#building_code').val(result[2].building_code);
						 $('#receipts_generation_remark').val('Deposit :'+result[2].building_name+'/'+result[3].unit_no+'/'+result[1].tenant_name+'@'+formatNumber(parseFloat(result[0].tenant_contract_rent).toFixed(3)));
                        if(unit_id == ''){  
                            $('#unit_id').html('');
...
/***************************************************************************************/
    $(document).on('blur','#receipts_generation_amt',function(){  
            ...
            $("#receipts_generation_remark").val("Deposit :"+$("#building_name").val()+'/'+$("#unit_name").val() +'/'+$("#tenant_name").val()+'@'+$("#receipts_generation_amt").val())
