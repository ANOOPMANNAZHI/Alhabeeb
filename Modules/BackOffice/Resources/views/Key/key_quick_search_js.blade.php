...
$(document).ready(function() {
	...
	$(document).on('change keyup paste','.search_fields',function(){ 
	  ...
	  var building_id 			            = $("#building__building_name").val();
	  var unit_id		        			= $("#Unit__unit_code").val(); 
	  ...
	  $.ajax({
			  method: "GET",
			  url: '{{$quick_url}}',
			  data: { 'building__building_name': building_id,'Unit__unit_code': unit_id,'route':'{{$quick_url}}', 'ajax' : true ,'fieldName' : fieldName , 'operation' : operation , 'fieldValue' : fieldValue , 'logic' : logic},			  
			  beforeSend: function(){
			  ...
			  success: function(data){ 
				...
				var txt = '' ;
				txt ='building__building_name='+building_id+'&Unit__unit_code='+unit_id;
