...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Rent Amount collected through Legal Case</div>
    </div>
    {{ Breadcrumbs::render('showLegalRentAmountReport') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
         @can('view_legal_rent_amount_report') 
      <form action="{{route('legalRentAmountReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}} 
