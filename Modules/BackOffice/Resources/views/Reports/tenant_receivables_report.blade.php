...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Tenant receivable as on (Date Range)</div>
    </div>
    {{ Breadcrumbs::render('showtenantReceivablesReport') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
           @can('view_tenant_receivables') 
      <form action="{{route('tenantReceivablesReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
           ...
           <!-- <div class="col-sm-6 val2">
              <div class="form-group">
                ...
                <div class="p-relative">
                 ...
                 <input  type="date" class="form-control" id="start_date"  placeholder="Enter Received Date" name="start_date" required>
                </div>
              </div>
            </div>
            <div class="col-sm-6 val2">
