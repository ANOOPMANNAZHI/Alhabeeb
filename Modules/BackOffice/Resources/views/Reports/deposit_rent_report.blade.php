...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Report on Deposit for rent / E,W</div>
    </div>
    {{ Breadcrumbs::render('showDepositRentReport') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
        @can('view_deposit_rent_report') 
      <form action="{{route('depositRentReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
...
<script>
 ...
 $('#building_code').autocomplete({
  source : '{!!URL::route('buildingsCodeReportAutocompleteCode')!!}',
  minlenght:2,
  autoFocus:true,
