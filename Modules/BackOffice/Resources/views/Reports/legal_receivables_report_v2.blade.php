...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Legal Receivable v2 as on (Date)</div>
    </div>
    {{ Breadcrumbs::render('showLegalReceivablesReportV2') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
           @can('view_legal_receivables_v2')
      <form action="{{route('legalReceivablesReportPdfV2')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
