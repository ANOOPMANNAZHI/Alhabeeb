...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Report on flats Rented - Employee wise</div>
    </div>
    {{ Breadcrumbs::render('showEmployeeTenantContractReport') }}
  </div>
</div>
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
         @can('employee_tenant_contract_report')  
      <form action="{{route('employeeTenantContractReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}} 
        <div class="dataSearchBox ">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label for="end_date">To Date<small class="textRed">*</small></label>
                <div class="p-relative">
                  <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="p-relative">
                  <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
                  <select class="form-control" name="tenant_marketing_executive">
