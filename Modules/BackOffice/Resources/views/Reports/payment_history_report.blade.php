...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">Tenant's Payment History - Agreement Wise</div>
    </div>
...
<div class="row">
  <div class="col">
    <div class="card card-box salesSearchBox">
      ...
      <form action="{{route('paymentHistoryReportPdf')}}" target="_blank" method="POST" id="form_sample_2" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
