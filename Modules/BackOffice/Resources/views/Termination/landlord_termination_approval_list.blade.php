...
@section('search_url', route('LCTerminationApproval')) 
@section('search_reset', route('LCTerminationApproval')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        ...
        {{ Breadcrumbs::render('LCTerminationApproval') }}  
    </div>
</div>
                ...
                <thead>
                    ...
                    <tr>
                       <td> <input autocomplete="off" type="text" name="landlord_contract_no" class="search_fields mob" id="landlord_contract_no" value="{{old('landlord_contract_no')}}" ></td>
                        ...
                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('LCTerminationApproval')}}" ></td>
                        <td></td>
                    </tr>
                </thead>
                <tbody id="enquiry-search">
                 
                  @include('backoffice::Termination.landlord_termination_approval_list_ajax')  
...
$(document).ready(function(){
  $(document).on('click','.Approve', function(e) {    
    $outstanding = $(this).prev('input').attr('value');    
    //$outstanding = $("#outstanding").val();
    //if($outstanding > 0){
      //alert("Units Have Outstanding..!Please Clear All Outstanding To Continue Terminate");
      //return false;
    //}else{
     // return true;
    //}
