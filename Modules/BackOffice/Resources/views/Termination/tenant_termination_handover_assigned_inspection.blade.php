    ...
    <div class="col-md-6 p-t-10">
      ...
      <div class="col-md-6 p-t-10">
        <div class="row">
          ...
          <div class="col-md-1 s-clm">:</div>
          <div class="col-md-6">{{$tenantContract->building->location->locations_name??'NA'}} </span></div>
        </div>
      </div>
      <div class="col-md-6 p-t-10">
        <div class="row">
...
<div class="col-md-6 p-t-10">
    <div class="row">
      <div class="col-md-5"><b> Last Paid Up To</b></div>
      <div class="col-md-1 s-clm">:</div>
      <div class="col-md-6"><span>@if(!empty($tenantContract->tenant_contract_last_paid_date))
...
<div class="col-md-6 p-t-10">
  <div class="row">
    ...
    <div class="col-md-1 s-clm">:</div>
    <div class="col-md-6"><span>{{$termination->termination_remark?? "NA"}}</span></div>
  </div>
</div> 
...
<!-- ends -->
@if($termination->termination_electricity_acc_no || $termination->termination_electricity_close_reading || $termination->termination_electricity_amount || $termination->termination_water_acc_no || $termination->termination_water_close_reading || $termination->termination_water_amount)
<div class="col-md-12">
  <div class="card card-box salesSearchBox " id="agdiv">
    <div class="dataSearchBox">
      <div class="card-body row">
        @if($termination->termination_electricity_acc_no)
        ...
        @endif
        @if($termination->termination_electricity_close_reading)
        <div class="col-lg-4 p-t-20"> 
          <div class = "txt-full-width">
        ...
        @endif
        @if($termination->termination_electricity_amount)
        <div class="col-lg-4 p-t-20"> 
          <div class = "txt-full-width">
        ...
        @endif
        @if($termination->termination_water_acc_no)
        <div class="col-lg-4 p-t-20"> 
          <div class = "txt-full-width">
        ...
        @endif
        @if($termination->termination_water_close_reading)
        <div class="col-lg-4 p-t-20"> 
          <div class = "txt-full-width">
        ...
        @endif
        @if($termination->termination_water_amount)
        <div class="col-lg-4 p-t-20"> 
          <div class = "txt-full-width">
...
@if(count($tenantContract->terminationChecklist) >0)
  ...
  <div class="card card-box salesSearchBox " id="agdiv">
    ...
    <div class="dataSearchBox">
      <div class="card-body row">
       ...
       <div class="col-lg-6 p-t-20"> 
        <div class = "txt-full-width">
          <h5 class="details"><b> {{$subWork->subWorks->sub_work}}:  </b><span>{{numberFormat($subWork->termination_amount)}}</span></h5>
  ...
  <div class="card card-box salesSearchBox " id="agdiv">
   ...
   <div class="dataSearchBox">
    <div class="card-body row">
      ...
      <div class="col-lg-6 p-t-20"> 
        <div class = "txt-full-width">
          <h5 class="details"><b>{{$other->termination_other_work}} :  </b><span>{{numberFormat($other->termination_amount)}}</span></h5>
  ...
  <div class="card card-box salesSearchBox " id="agdiv">
    <div class="dataSearchBox">
      <div class="card-body row">
		...
		<div class="col-lg-6 p-t-20"> 
          <div class = "txt-full-width">
            <h5 class="details"><b>Total Other :  </b><span> 
             {{isset($totalOtherAmt)? numberFormat($totalOtherAmt). " OMR":0.000 }}</span></h5>           
          </div>
        </div>
        <div class="col-lg-6 p-t-20"> 
          <div class = "txt-full-width">
...
<form id="save_inspection" method="POST" action ="{{route('terminationInspectionStore')}}"method="POST"  class="form-horizontal" enctype="multipart/form-data" data-toggle="validator"  >{{csrf_field()}}
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-12 p-t-10">
          <div class="row">
            ...
            <div class="col-md-2"><input type="text" name="elec_acc" class="form-control read" value="{{$tenantContract->unit->unit_electric_consumer_no ?? ''}}" readonly></div>
            <div class="col-md-2"><b>Closing Reading</b></div>
            <div class="col-md-2"><span><input type="text" name="elec_cls_read" class="form-control " value=""></span></div>
            <div class="col-md-2"><span><b>Amount R O</b></span></div>
            <div class="col-md-2"><span><input type="text" name="elec_amt" class="form-control elec_water" value="" id="elec_amt" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
          </div>
          <div class="row">
            <div class="col-md-2"><b>Water Acc/No</b></div>
            <div class="col-md-2"><input type="text" name="water_acc" class="form-control read" value="{{$tenantContract->unit->unit_water_consumer_no ?? ''}}" readonly></div>
            <div class="col-md-2"><b>Closing Reading</b></div>
            <div class="col-md-2"><span><input type="text" name="water_cls_read" class="form-control " value=""></span></div>
            <div class="col-md-2"><span><b>Amount R O</b></span></div>
            <div class="col-md-2"><span><input type="text" name="water_amt" class="form-control elec_water" value="" id="water_amt" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
          </div>
        </div>
      </div>
  ...
  <div class="card-body row">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-12 p-t-10">
        ...
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" class = "mdl-switch__input sub_chk" name="addinspection{{$i}}" value="{{$subWork->id}}" id="{{preg_replace('/\s+/', '', $subWork->sub_work)}}{{$i}}" ></div>
          <div class="col-md-5"><b>{{$subWork->sub_work}}</b></div>
          <input type="hidden" name="checkId[]" value="{{preg_replace('/\s+/', '', $subWork->sub_work)}}{{$i}}">
          <div class="col-md-3 s-clm"><input type="text" name="quantity_{{$i}}" class="form-control quantity" value="" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric Values"></div>
          <div class="col-md-3"><span><input type="text" name="amount_{{$i}}" class="form-control amount" value="" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        @php $i++; @endphp
        @endforeach
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-12 p-t-10">
        ...
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "Others0"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_0" value="Others" datas-id=""data_ac_key = ""></div>
          <div class="col-md-5"><b>Others</b></div>
          <input type="hidden" name="checkId[]" value="Others0">
          <div class="col-md-3 s-clm"><input type="text" name="addinspectionQuantity_0" class="form-control quantity" value="" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric Values"></div>
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_0" class="form-control amount total_other" value="" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "Rent1"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_1" value="Rent" datas-id=""data_ac_key = ""></div>
          <div class="col-md-5"><b>Rent</b></div>
          <input type="hidden" name="checkId[]" value="Rent1">
          <div class="col-md-3 s-clm"><input type="text" name="addinspectionQuantity_1" class="form-control quantity" value="" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric Values"></div>
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_1" class="form-control amount total_other" value="" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "MuncipalTax2"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_2" value="Muncipal Tax" datas-id=""data_ac_key = ""></div>
          <div class="col-md-5"><b>Muncipal Tax</b></div>
          <input type="hidden" name="checkId[]" value="MuncipalTax2">
          <div class="col-md-3 s-clm"><input type="text" name="addinspectionQuantity_2" class="form-control quantity" value="" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric Values"></div>
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_2" class="form-control amount total_other" value="" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "AnyOtherCharges3"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_3" value="Any Other Charges" datas-id=""data_ac_key = ""></div>
          <div class="col-md-5"><b>Any Other Charges</b></div>
          <input type="hidden" name="checkId[]" value="AnyOtherCharges3">
          <div class="col-md-3 s-clm"><input type="text" name="addinspectionQuantity_3" class="form-control quantity" value="" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric Values"></div>
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_3" class="form-control amount total_other" value="" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
      </div>
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-12 p-t-10">
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "switch-2"      class = "mdl-switch__input" name="termination_main_key_status" value="1" datas-id=""data_ac_key = ""></div>
          <div class="col-md-5"><b>Main Door Key Received</b></div>
          <div class="col-md-1 s-clm">Notes</div>
          <div class="col-md-5"><span><textarea class="form-control" name="notes" required=""></textarea></span></div>
        </div>
      </div>
    </div>
    <div class="col-md-12 ">
      ...
      <div class="col-md-12 p-t-10">
        <div class="row ">
          ...
          <div class="col-md-5 "><input type="text" name="total" class="form-control total " value="" id="total" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" readonly></div>
        </div>
        <div class="row ">
          <div class="col-md-4 "><b>Total Of Electricity & Water</b></div>
          <div class="col-md-5 "><input type="text" name="elec_water_total" class="form-control total " value="" id="elec_water_total" readonly></div>
        </div>
		<div class="row ">
          <div class="col-md-4 "><b>Total Other</b></div>
          <div class="col-md-5 "><input type="text" name="total_others" class="form-control total " value="" id="total_others" readonly></div>
        </div>
        <div class="row ">
          <div class="col-md-4 "><b>Discount On Total Maintenance Due</b></div>
          <div class="col-md-5 "><input type="text" name="maintenance_due" class="form-control total " value="" id="maintenance_due"></div>
        </div>
        <div class="row ">
          <div class="col-md-4 "><b>Net Amount</b></div>
          <div class="col-md-5 "><input type="text" name="net" class="form-control total " value="" id="net" readonly data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values"></div>
        </div>
      </div>
    </div>
    <div class="col-md-12 ">
    ...
    $(document).on('change','.amount,.quantity',function(){
      ...
      $("[type=checkbox]").each(function(index) {
        if($(this).is(':checked')){
          ...
          var amount = $(this).closest("div.row").find("input[name='amount_"+index+"']").val().replace(/,/g, '');
          var othetAmount = $(this).closest("div.row").find("input[name='addinspectionAmount_"+index+"']").val();
          var othetQuantity = $(this).closest("div.row").find("input[name='addinspectionQuantity_"+index+"']").val();
          if(quantity == "" || !$.isNumeric(quantity) )quantity = 0;
          if(amount == "")amount = 0.000;
          if(othetAmount == "" || !$.isNumeric(othetAmount) )othetAmount = 0;
          if(othetQuantity == "" || !$.isNumeric(othetQuantity) )othetQuantity = 0;
          //total  = parseFloat(quantity) * parseFloat(amount);
        ...
        //alert(formatNumber(sum.toFixed(3)));
        $("#total").val(formatNumber(sum.toFixed(3)));
        netAmount();
      });
      $(".otherCheck").each(function(index) {
