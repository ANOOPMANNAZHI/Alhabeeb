...
@section('search_url', route('LCTerminationVerify')) 
@section('search_reset', route('LCTerminationVerify'))
...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    <div class=" pull-left">
      <div class="page-title">LC Termination Verification</div>
    </div>
     {{ Breadcrumbs::render('LCTerminationVerify') }} 
  </div>
</div>
    ...
    <h4>
      ...
      <table class="table display product-overview mb-30" id="dtBasicExample">
        <thead>
          ...
          <td> <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('LCTerminationVerify')}}" ></td>
       ...
       <tbody id="enquiry-search">
        ...
        @include('backoffice::Termination.landlord_termination_verification_list_ajax')  
