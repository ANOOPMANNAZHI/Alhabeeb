...
$(document).ready(function() {
	...
	$(document).on('change keyup paste','.search_fields',function(){ 
	  ...
	  $.ajax({
			  method: "GET",
			  url: '{{$quick_url}}',
			  data: { 'landlord_contract_no': landlord_contract_no,'landlord_contract_valid_from_date': landlord_contract_valid_from_date,'landlord_contract_valid_to_date': landlord_contract_valid_to_date,'building_name': buildingInfo__building_name,'vendor_name': vendorInfo__vendor_name,'route':'{{$quick_url}}', 'ajax' : true ,'fieldName' : fieldName , 'operation' : operation , 'fieldValue' : fieldValue , 'logic' : logic },			  
			  beforeSend: function(){
			  ...
			  success: function(data){ 
				...
				txt = 'landlord_contract_no='+landlord_contract_no+'&landlord_contract_valid_from_date='+landlord_contract_valid_from_date + '&landlord_contract_valid_to_date='+landlord_contract_valid_to_date+ '&building_name='+buildingInfo__building_name+'&vendor_name='+vendorInfo__vendor_name;
