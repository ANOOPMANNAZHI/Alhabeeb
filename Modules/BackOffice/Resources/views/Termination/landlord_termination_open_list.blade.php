...
@section('search_url', route('landlordTermination.index')) 
@section('search_reset', route('landlordTermination.index')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        ...
        {{ Breadcrumbs::render('landlordTermination.index') }} 
    </div>
</div>
 ...
 <div class="col-md-12 col-sm-12">
    <div class="card  card-box">
       ...
       <h4>
        ...
        <a href="{{route('landlordTermination.create')}}" class="btn btn-circle btn-primary  align-right"  >Early Termination</a>
        @endcan
            <div class="clr"></div>
            </h4>
            ...
            <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    ...
                    <tr>
                       <td> <input autocomplete="off" type="text" name="landlord_contract_no" class="search_fields mob" id="landlord_contract_no" value="{{old('landlord_contract_no')}}" ></td>
                        ...
                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('terminationRequestSearch')}}" ></td>
                ...
                <tbody id="enquiry-search">
                  ...
                  @include('backoffice::Termination.landlord_termination_open_list_ajax')  
