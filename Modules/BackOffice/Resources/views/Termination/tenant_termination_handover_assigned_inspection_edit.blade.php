  ...
  <div class="card-body row">
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-12 p-t-10">
        ...
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "Rent1"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_1" value="Rent" {{ (isset($tenantContract->terminationChecklistOther) && in_array("Rent",$otherArray)) || (!in_array("Rent",$otherArray) && ($suggested['rent']['amount'] ?? 0) > 0) ? 'checked' : '' }}></div>
          <div class="col-md-5"><b>Rent</b>@if(!empty($suggested['rent']['note']))<br><small class="text-muted">{{ $suggested['rent']['note'] }}</small>@endif @if(!empty($suggested['rent']['detail']))<br><small class="text-danger">{{ $suggested['rent']['detail'] }}</small>@endif</div>
          ...
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_1" class="form-control Otheramount total_other" value="{{ (isset($tenantContract->terminationChecklistOther) && in_array('Rent',$otherArray)) ? $tenantContract->terminationChecklistOther->where('termination_other_work','Rent')->first()->termination_amount : (($suggested['rent']['amount'] ?? 0) > 0 ? number_format($suggested['rent']['amount'], 3, '.', '') : '') }}" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        <div class="row">
          <div class="col-md-1"><input type = "checkbox" id = "MuncipalTax2"      class = "mdl-switch__input sub_chk otherCheck" name="addinspectionOther_2" value="Muncipal Tax" {{ (isset($tenantContract->terminationChecklistOther) && in_array("Muncipal Tax",$otherArray)) || (!in_array("Muncipal Tax",$otherArray) && ($suggested['municipal_tax']['amount'] ?? 0) > 0) ? 'checked' : '' }}></div>
          <div class="col-md-5"><b>Muncipal Tax</b>@if(!empty($suggested['municipal_tax']['note']))<br><small class="text-muted">{{ $suggested['municipal_tax']['note'] }}</small>@endif</div>
          ...
          <div class="col-md-3"><span><input type="text" name="addinspectionAmount_2" class="form-control Otheramount total_other" value="{{ (isset($tenantContract->terminationChecklistOther) && in_array('Muncipal Tax',$otherArray)) ? $tenantContract->terminationChecklistOther->where('termination_other_work','Muncipal Tax')->first()->termination_amount : (($suggested['municipal_tax']['amount'] ?? 0) > 0 ? number_format($suggested['municipal_tax']['amount'], 3, '.', '') : '') }}" data-rule-pattern="\d+(\.\d{2})?" data-msg-pattern="Allowed only Numeric and Decimal Values" onkeyup="FormatCurrency(this)"></span></div>
        </div>
        <div class="row">
