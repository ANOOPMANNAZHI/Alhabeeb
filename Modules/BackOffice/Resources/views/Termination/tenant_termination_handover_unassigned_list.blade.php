...
@section('search_url', route('handoverUnassigned')) 
@section('search_reset', route('handoverUnassigned'))  
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Handover Unassigned</div>
        </div>
         {{ Breadcrumbs::render('handoverUnassigned') }}
    </div>
</div>
 ...
 <div class="col-md-12 col-sm-12">
    <div class="card  card-box">
        ...
        <div class="card-body ">
            ...
            @can('handover_assign')
            <button type="button" class="btn btn-circle btn-primary groupAssign align-right"  data-toggle="modal" data-target="#myModal" data-id="" data-backdrop="static" data-keyboard="false"> Assign</button>
            @endcan
            <div class="clr"></div>
            </h4>
            ...
            <table class="table display product-overview mb-30" id="dtBasicExample">
                ...
                <tbody id="enquiry-search">
                  ...
                  @include('backoffice::Termination.tenant_termination_handover_unassigned_list_ajax')  
