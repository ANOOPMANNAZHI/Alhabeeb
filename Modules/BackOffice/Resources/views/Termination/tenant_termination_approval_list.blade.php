...
@endsection
@section('search_url', route('tenantTerminationApproval')) 
@section('search_reset', route('tenantTerminationApproval')) 
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Termination Approval List </div>
        </div>
         {{ Breadcrumbs::render('tenantTerminationApproval') }}  
    </div>
</div>
        ...
        <h4>
            ...
            <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    ...
                    <tr>
                       <td> <input autocomplete="off" type="text" name="contract_no" class="search_fields mob" id="contract_no" value="{{old('tenant_contract_no')}}" ></td>
                        ...
                        <td><input autocomplete="off" type="text" name="tenant_contract_rent" class="search_fields mob" id="tenant_contract_rent"  value="{{old('tenant_contract_rent')}}" >
                ...
                <tbody id="enquiry-search">
                  ...
                  @include('backoffice::Termination.tenant_termination_approval_list_ajax')  
