...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    ...
    {{ Breadcrumbs::render('newContractShow',$tenantContract,301) }}  
...
@endif
@if($tenantContract->tenant_contract_value)
<div class="col-lg-6 p-t-20"> 
	<div class = "txt-full-width">
	<h5 class="details"><b>Contract Value :  </b><span>{{$tenantContract->tenant_contract_value}}</span></h5>
	</div>
</div>
@endif
          ...
          <form id="renewal_note-form" action="{{route( 'storeRenewalNote')}}"" method="POST">
            ...
            <div class="col-sm-12">
              <div class="form-group">
                ...
                <input type="hidden" name="renewal_id" value="{{$tenantContract->renewalContract->id}}">
