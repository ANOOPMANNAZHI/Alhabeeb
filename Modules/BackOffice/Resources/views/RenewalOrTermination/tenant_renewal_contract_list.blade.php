...
@section('search_url', route('tenantRenewalContract'))
@section('search_reset', route('tenantRenewalContract'))
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Contract Renewal</div>
        </div>
         {{ Breadcrumbs::render('tenantRenewalContract') }}
    </div>
</div>
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    ...
                    <tbody id="enquiry-search">                                                             
                                @include('backoffice::RenewalOrTermination.tenant_renewal_contract_list_ajax')                                 
                    </tbody>
