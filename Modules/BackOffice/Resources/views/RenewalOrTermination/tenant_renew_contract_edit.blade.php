...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Renewal Contract Update</div>
        </div>
        {{ Breadcrumbs::render('renewalContractUpdate',$tenantContract->id) }}
    </div>
</div>
<div class="row">
<div class="col">
<div class="card card-box salesSearchBox">
<form action="{{route('tenantRenewal.update',$tenantContract->id)}}" method="POST" id="tenant_contract_form"" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control read" id="tenant_contract_no" readonly name="tenant_contract_no" required value="{{$tenantContract->tenant_contract_no}}">
                    </div>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="old_tenant_contract_date">Agreement Date <small class="textRed">*</small></label>
                    <div class="p-relative">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control  read" id="tenant_contract_old_no" readonly name="tenant_contract_old_no" required value="{{$tenantContract->tenant_contract_old_no}}">
                </div>
                </div>
            </div>
...
<div class="dataSearchBox ">
        ...
        <div class="col-sm-4">
            <div class="form-group">
                ...
                " id="occupant_name" placeholder="Enter Occupant Name" required name="occupant_name" value="{{(isset($tenantContract))?((!isset($tenantContract->occupant_id))?$tenantContract->tenant->tenant_contact_no:$tenantContract->occupant->occupant_primary_contact_no):old('occupant_primary_contact_no','')}}" onkeypress="return isNumber(event)">
            </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="text" class="form-control mob_validation_13" id="simpleFormEmail" placeholder="Enter Occupant Mob No" name="occupant_primary_contact_no" value="{{old('occupant_primary_contact_no',isset($tenantContract->occupant_id)? $tenantContract->occupant->occupant_primary_contact_no : '')}}">
            </div>
            </div>
        </div>
        <div class="col-sm-4">
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="simpleFormEmail" placeholder="Enter Occupant Email Id" name="occupant_email" value="{{(isset($tenantContract->occupant_id))?old('occupant_email',((!isset($tenantContract->occupant_id))?$tenantContract->tenant->tenant_contact_email:$tenantContract->occupant->occupant_email)):old('occupant_email','')}}">
            </div>
            </div>
        </div>
        <div class="w-100"></div>
         ...
         <div class="col-sm-6">
                <div class="form-group">
                    <label for="tenant_contract_start_date">Start Date<small class="textRed">*</small></label>
                     <div class="p-relative">
                    <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
                    <input type="date" required class="form-control " id="tenant_contract_start_date" placeholder="Enter start date" name="tenant_contract_start_date" value="{{old('tenant_contract_start_date',isset($tenantContract->tenant_contract_start_date)? $tenantContract->tenant_contract_start_date->format('Y-m-d') : '')}}">
                </div>
                </div>
            </div>
            <div class="col-sm-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control rent" id="tenant_contract_rent" onkeyup="FormatCurrency(this)" placeholder="Enter Rent (P.M)" name="tenant_contract_rent" value="{{ isset($tenantContract)?  old('tenant_contract_rent',numberFormat($tenantContract->tenant_contract_rent)): old('tenant_contract_rent','')}}" required data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" >
            </div>
            </div>
        </div>
        ...
        <div class="row">
           <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="p-relative">
                    <i class="fa fa-money icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control" id="tenant_contract_deposit_amt" placeholder="Enter Deposit Rent Amount" onkeyup="FormatCurrency(this)" name="tenant_contract_deposit_amt"  value="{{ isset($tenantContract)?  old('tenant_contract_deposit_amt',numberFormat($tenantContract->tenant_contract_deposit_amt)): old('tenant_contract_deposit_amt','')}}" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values">
            </div>
            </div>
        </div>
         <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="p-relative">
                    <i class="fa fa-money icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control" id="tenant_contract_guarantee_cheque_details" placeholder="Enter Guarantee Cheque Amount" name="tenant_contract_guarantee_cheque_details" onkeyup="FormatCurrency(this)"  value="{{ isset($tenantContract)?  old('tenant_contract_guarantee_cheque_details',numberFormat($tenantContract->tenant_contract_guarantee_cheque_details)): old('tenant_contract_guarantee_cheque_details','')}}" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values">
            </div>
            </div>
        </div>
        <div class="w-100"></div>
        <div class="col-sm-4">
         ...
         <div class="col-sm-4">
            <div class="form-group">
                ...
                <div class="p-relative">
                    <i class="fa fa-money icn-add" aria-hidden="true"></i>
                <input type="text" class="form-control" name="tenant_contract_receipt_amount" id="simpleFormEmail" onkeyup="FormatCurrency(this)" placeholder="Enter Receipt Amount" data-rule-pattern="^-?(?:\d+|\d{1,3}(?:,\d{3})+)(?:(\.|,)\d+)?$" data-msg-pattern="Allowed only Numeric and Decimal Values" value="{{ isset($tenantContract)?  old('tenant_contract_receipt_amount',numberFormat($tenantContract->tenant_contract_receipt_amount)): old('tenant_contract_receipt_amount','')}}">
            </div>
            </div>
        </div>
        <div class="w-100"></div>
...
//$('#tenant_contract_valid_to_date').attr('min', maxDate);
  //  $('#tenant_contract_valid_to_date').attr('max', '{{$landlord_contract_valid_to_date}}');
