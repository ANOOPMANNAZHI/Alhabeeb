...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    ...
    {{ Breadcrumbs::render('renewalPdc',$breadcrumbParent, $params)}}
   ...
   <div class="col">
     <div class="card card-box salesSearchBox">
       <div class="card-body row">
        ...
        <div class="col-lg-6 p-t-20"> 
          <div class = "txt-full-width">
            <h5 class="details"><b>No of Checks :  </b>
          ...
          <div class="table-responsive">
           ...
           <tr class="chkRow" id="tr_{{$key}}">   
            ...
            <td>
             ...
             <select name="temp_pdc_cancel_reason_{{$key}}" class="pdc_cancel_reason" {{($isDisable)?'readonly':''}} id="temp_pdc_cancel_reason_{{$key}}">
              <option value="">Select</option>
