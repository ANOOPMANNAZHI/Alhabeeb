<div class="modal-dialog assign">
   ...
   <div class="row">
    <div class="col">
        ...
        <form action="{{route('renewalApproveRejectStore')}}" autocomplete="off" method="POST" id="renewal_note_modal" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
        <input  type="hidden" class="form-control" name="contract_id" value="{{$contract_id}}">
        <input  type="hidden" class="form-control" name="stage" value="{{$stage}}">
