...
$(document).ready(function() {
	...
	$(document).on('change keyup paste','.search_fields',function(){ 
	  ...
	  var new_contract_no 					= $("#new_contract_no").val();
	  ...
	  $.ajax({
			  method: "GET",
			  url: '{{$quick_url}}',
			  data: { 'new_contract_no': new_contract_no,'contract_no': contract_no,'tenant_contract_rent': tenant_contract_rent, 'tenant_contract_old_no': tenant_contract_old_no,'building_name': building_id,'unit_code': unit_id,'tenant_contract_start_date': tenant_contract_start_date,'tenant_contract_valid_to_date': tenant_contract_valid_to_date,'email_count':email_count,'category':category,'tenant_name': tenant_id,'tenant_contract_muncipality_agr_no': tenant_contract_muncipality_agr_no,'route':'{{$quick_url}}','locations_name':locationId,'tenant_contact_no':tenant_contact_no,'tenant_contact_address':way_no,"_token" : $('meta[name="csrf-token"]').attr('content') , 'ajax' : true ,'fieldName' : fieldName , 'operation' : operation , 'fieldValue' : fieldValue , 'logic' : logic,
			  ...
			  success: function(data){ 
				...
				var txt = '' ;
				txt = 'new_contract_no='+new_contract_no+'&tenant_contract_no='+contract_no+'&tenant_contract_rent='+tenant_contract_rent+'&tenant_contract_old_no='+tenant_contract_old_no+'&building_name='+ building_id+'&unit_code='+unit_id+'&tenant_contract_start_date='+ tenant_contract_start_date+'&tenant_contract_valid_to_date='+ tenant_contract_valid_to_date+'&tenant_name='+ tenant_id+'&tenant_contract_muncipality_agr_no='+ tenant_contract_muncipality_agr_no+'&locations_name='+locationId+'&tenant_contact_no='+tenant_contact_no+'&tenant_contact_address='+way_no+'&tenant_contract_last_paid_date='+tenant_contract_last_paid_date+'&email_count='+email_count+'&category='+category+'&termination_date='+termination_date;
