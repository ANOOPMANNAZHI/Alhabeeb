...
@endsection
 ...
 @section('search_url', route('landlordRenewal.index')) 
@section('search_reset', route('landlordRenewal.index'))  
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Landlord-Due for Renewal</div>
        </div>
    ...
    <div class="card  card-box">
     ...
     <div class="table-responsive"> 
            <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    <tr>
                        <th>@sortablelink('landlord_contract_no','Contract No',[],[ 'class' => 'sort_url'])</th>
                        <th>@sortablelink('buildingInfo__building_name','Building',[],[ 'class' => 'sort_url'])</th>
                        ...
                        <th>@sortablelink('vendorInfo__vendor_name','Landlord',[],[ 'class' => 'sort_url'])</th>
                        <th>Action</th>
                    </tr>
                    <tr>
                       <td> <input autocomplete="off" type="text" name="landlord_contract_no" class="search_fields mob" id="landlord_contract_no" value="{{old('landlord_contract_no')}}" ></td>
                        ...
                        <td><input autocomplete="off" type="text" name="building_id" class="search_fields mob" id="buildingInfo__building_name"  value="{{old('buildingInfo__building_name')}}" ></td>
                        ...
                        <td><input autocomplete="off" type="text" name="vendor_id" class="search_fields mob" id="vendorInfo__vendor_name"  value="{{old('vendorInfo__vendor_name')}}" ></td>

                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('landlordDueSearch')}}" ></td>
                        <td></td>
                    </tr>
                </thead>
                <tbody id="enquiry-search">
                 
                  @include('backoffice::RenewalOrTermination.landlord_renewal_due_list_ajax')  
            ...
            <div class="row "  id="pagination">                            
                {{$renewalDues->appends(\Request::except(['page','_token']))->links()}} 
           </div> 
...
@include('backoffice::RenewalOrTermination.landlord_due_search_js') {{--quick search --}}
<script>   
