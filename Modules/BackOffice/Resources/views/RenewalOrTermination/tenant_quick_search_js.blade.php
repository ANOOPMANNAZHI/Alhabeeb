...
$(document).ready(function() {
	...
	$(document).on('change keyup paste','.search_fields',function(){ 
	  ...
	  $.ajax({
			  method: "GET",
			  url: '{{$quick_url}}',
			   data: { 'new_contract_no': contract_no,'contract_no': contract_no,'tenant_contract_rent': tenant_contract_rent, 'tenant_contract_old_no': tenant_contract_old_no,'building_name': building_id,'building_no': building_no,'unit_code': unit_id,'Unit__unit__unit_types_name': unit_types_name,'tenant_contract_start_date': tenant_contract_start_date,'tenant_contract_valid_to_date': tenant_contract_valid_to_date,'tenant_name': tenant_id,'tenant_contract_muncipality_agr_no': tenant_contract_muncipality_agr_no,'route':'{{$quick_url}}','tenant__location__locations_name':locationId,'tenant__tenant_contact_no':tenant_contact_no,'tenant__tenant_contact_address':way_no,"_token" : $('meta[name="csrf-token"]').attr('content') , 'ajax' : true ,'fieldName' : fieldName , 'operation' : operation , 'fieldValue' : fieldValue , 'logic' : logic,
			  ...
			  success: function(data){ 
				...
				var txt = '' ;
				txt = 'tenant_contract_no='+contract_no+'&tenant_contract_rent='+tenant_contract_rent+'&tenant_contract_old_no='+tenant_contract_old_no+'&building__building_name='+ building_id+'&building__building_no='+ building_no+'&Unit__unit_code='+unit_id+'&Unit__unit__unit_types_name='+unit_types_name+'&tenant_contract_start_date='+ tenant_contract_start_date+'&tenant_contract_valid_to_date='+ tenant_contract_valid_to_date+'&tenant__tenant_name='+ tenant_id+'&tenant_contract_muncipality_agr_no='+ tenant_contract_muncipality_agr_no+'&tenant__location__locations_name='+locationId+'&tenant__tenant_contact_no='+tenant_contact_no+'&tenant__tenant_contact_address='+way_no+'&tenant_contract_last_paid_date='+tenant_contract_last_paid_date+ 
			      '&termination_date='+termination_date;
