...
@section('search_url', route('tenantRenewal.index'))
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Tenant - Due For Renewal</div>
        </div>
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                <thead>
                    ...
                    <tbody id="enquiry-search">                                                             
                                @include('backoffice::RenewalOrTermination.tenant_renewal_due_list_ajax')                                 
                    </tbody>
