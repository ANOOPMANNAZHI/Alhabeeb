...
@endsection
 ...
 @section('search_url', route('landlordContractRenewed'))  
 @section('search_reset', route('landlordContractRenewed'))  
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Renewed Contract Grid</div>
        </div>
          {{ Breadcrumbs::render('landlordContractRenewed') }} 
    </div>
</div>
                ...
                <thead>
                    ...
                    <tr>
                       ...
                       <td> <input autocomplete="off" type="text" name="landlord_contract_no" class="search_fields mob" id="landlord_contract_no" value="{{old('landlord_contract_no')}}" ></td>
                        ...
                        <input autocomplete="off" type="hidden" name="url_route" id="url_route"  value="{{route('renewedContractSearch')}}" ></td>
                        <td></td>
                    </tr>
                </thead>
                <tbody id="enquiry-search">
                 
                  @include('backoffice::RenewalOrTermination.landlord_contract_renewed_list_ajax')  
