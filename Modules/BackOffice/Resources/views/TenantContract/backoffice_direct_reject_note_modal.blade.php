                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="p-relative">
							...
							<textarea class="form-control"  required id="sales_lead_note_name"  placeholder="Enter Note" name="sales_lead_note_name"  data-rule-maxlength="200" data-msg-maxlength="Only allows 200 Characters">{{ isset($salesActivity)?  old('sales_lead_note_name',$salesActivity->sales_activities_name): old('sales_lead_note_name')}}</textarea>
                        </div>
                    </div>
                  </div>
