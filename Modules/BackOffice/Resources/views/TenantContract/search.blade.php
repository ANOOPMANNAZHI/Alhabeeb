                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                       ...
                                       <div class="p-relative">
                                        ...
                                        @if(old('fieldName')[$i] == 'tenant_contract_status')
                                        <select class="form-control fieldValue" name="fieldValue[]" required>
                                          <option {{ (old('fieldValue')[$i] == 1)? 'selected': ''}} value="1">Active</option>
                                          <option {{ (old('fieldValue')[$i] == 0)? 'selected': ''}} value="0">InActive</option>    
                                        </select>
                                        @else 
