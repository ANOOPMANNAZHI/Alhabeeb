<div class="modal-dialog assign">
   ...
   <div class="row">
    <div class="col">
        ...
        <form action="{{  route('approvalAcceptReject')}}" autocomplete="off" method="POST" id="sales_note_modal" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
