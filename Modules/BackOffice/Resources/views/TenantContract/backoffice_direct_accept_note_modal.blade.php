<div class="modal-dialog assign">
    ...
    <div class="modal-header">
      <h4 class="modal-title">Accept Note</h4>
   ...
   <div class="row">
    <div class="col">
        ...
        <form action="{{route('directContractApprovalAcceptReject')}}" autocomplete="off" method="POST" id="sales_note_modal" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="p-relative">
							...
							<textarea class="form-control"  id="sales_lead_note_name"  placeholder="Enter Note" required name="sales_lead_note_name"   data-rule-maxlength="200" data-msg-maxlength="Only allows 200 Characters">{{ isset($salesActivity)?  old('sales_lead_note_name',$salesActivity->sales_activities_name): old('sales_lead_note_name')}}</textarea>
                        </div>
                    </div>
                  </div>
