            			...
            			<table class="table display product-overview mb-30" id="dtBasicExample">
            				<thead>
            					<tr>
            						...
            						<th>@sortablelink('building_name','Building',[],[ 'class' => 'contract_sort' ])</th>
...
<script>
        ...
        //  if(this.value != '')
			...
			showResultsTimer = window.setTimeout(function(){	
				$.ajax({
					method: "GET",
					url: route_href,
					data: {'tenant_contract_no': tenant_contract_no,'tenant_name':tenant__tenant_name,'building_name':building__building_name,'tenant_contract_rent':tenant_contract_rent,
					'unit_code': unit__unit_code, 'tenant_contract_valid_to_date':tenant_contract_valid_to_date,'tenant_contract_start_date':tenant_contract_start_date ,'invoice_check':invoice_check,'pdc_check':pdc_check, 'tenant_contract_is_reg_municipality':tenant_contract_is_reg_municipality ,'ajax' : true ,
  ...
  var txt = 'tenant_contract_no='+tenant_contract_no+'&tenant_name='+tenant__tenant_name+'&building_name='+building__building_name+'&tenant_contract_rent='+tenant_contract_rent+'&unit_code='+ unit__unit_code+'&tenant_contract_valid_to_date='+tenant_contract_valid_to_date+'&tenant_contract_start_date='+tenant_contract_start_date+'&invoice_check='+invoice_check+'&pdc_check='+pdc_check+'&tenant_contract_is_reg_municipality='+tenant_contract_is_reg_municipality;
