...
class ViewTenantTermination extends Model
{
	use Sortable;

	protected $table 	= 'view_tenant_termination';
    ...
    */
    public function terminationChecklist() {
           ...
           return $this->hasMany('Modules\BackOffice\Entities\TerminationChecklist','termination_contract_id','contract_id')->whereNotNull('work_id');
    }
  ...
  */
  public function scopeAreFilter($query){
    ...
    */
    ...
    public function scopeFilterWithoutUsers($query) {
