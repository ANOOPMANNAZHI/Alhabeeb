...
class ViewRenewalUserR extends Model
{
	use Sortable;
	protected $guarded 	= [];
	protected $table 	= 'view_renewal_users_rr';
	...
	*/
	public function scopeFilter($query, $request){
		...
		// dd($request);
			...
			foreach($request->except(['_token','sort','direction','page','curr_url','fieldValues','ajax','operation','logic','route','fc_att','termination_date','renewal_days','no_days','expdays','not_registered']) as $key => $val){         
