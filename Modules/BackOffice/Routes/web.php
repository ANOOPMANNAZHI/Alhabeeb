...
/***************Report Starts******************/
	...
	// Payment History V2 - same filters as showPaymentHistoryReport, but grouped
	// per contract with subtotals and a grand total
	Route::get('showPaymentHistoryReportV2', 'PaymentHistoryV2Controller@index')->name('showPaymentHistoryReportV2');
	Route::post('paymentHistoryReportV2Download', 'PaymentHistoryV2Controller@download')->name('paymentHistoryReportV2Download');
	...
	Route::resource('landlord-invoice-v2', 'LandlordInvoiceV2Controller');
	...
	Route::get('landlord-invoice-v2-vendors-by-building', 'LandlordInvoiceV2Controller@vendorsByBuilding')->name('landlordInvoiceV2VendorsByBuilding');
	Route::get('landlord-invoice-v2-contracts-by-building-vendor', 'LandlordInvoiceV2Controller@contractsByBuildingVendor')->name('landlordInvoiceV2ContractsByBuildingVendor');
