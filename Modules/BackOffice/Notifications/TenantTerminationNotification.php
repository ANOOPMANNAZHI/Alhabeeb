...
class TenantTerminationNotification extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'href' => (!isset($this->termination->href)) ? route('tenantTermination.show',$this->termination->contract_id) : $this->termination->href,     
