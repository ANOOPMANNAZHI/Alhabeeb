...
@section('search_url', route('complaintClosedList'))
@section('search_reset', route('complaintClosedList'))
@section('content')
    <!-- start widget -->
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
         ...
         {{ Breadcrumbs::render('complaintClosedList') }}
    </div>
</div>
            ...
            <div class="table-wrap">
              ...
              <table class="table display product-overview mb-30" id="dtBasicExample">
                ...
                <tbody id="enquiry-search">
                   ...
                   @include('maintenance::ComplaintStages.complaint_closed_list_ajax') 
