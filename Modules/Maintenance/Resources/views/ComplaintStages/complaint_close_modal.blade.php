<div class="modal-dialog assign">
   ...
   <div class="row">
    <div class="col">
        ...
        <form action="{{route('complaintCloseModalAction')}}" autocomplete="off" method="POST" id="sales_note_modal" class="form-horizontal sales_note_modal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
