...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    ...
    {{ Breadcrumbs::render('contractorServiceReport',$ticket) }}
  </div>
</div>
    ...
    <div class="card-box">
     <div class="card-head">
      <h4>
       ...
       @endunlessrole
        <!-- <button type="button" class="btn btn-circle btn-primary align-right updateStatus" title="Update Status" data-toggle="modal" data-target="#myModal" data-id="{{$ticket->complaint_service_report_id}}" datas-id = "{{$ticket->complaintChecklist->complaintEnquiry->id}}" dataa-id="" dataaw-id="{{$work_flow}}">UPDATE STATUS</button> -->
       <div class="clr"></div>
     </h4>
   </div>
   <form action="#" id="form_sample_2" class="form-horizontal">
    ...
    <div class="col-md-6 p-t-10">
      ...
      <div class="row float-right">
        <button type="button" class="btn btn-circle btn-primary align-right updateStatus" title="Update Status" data-toggle="modal" data-target="#myModal" data-id="{{$ticket->complaint_service_report_id}}" datas-id = "{{$ticket->complaintChecklist->complaintEnquiry->id}}" dataa-id="note"><i class="fa fa-pencil"></i></button>
      </div>
    </div>
...
<div class="col-sm-12">
  <div class="card-box">
    <div class="add-note-section">
      <form autocomplete="off" action="{{route('storeServiceReportNote')}}" method="POST" id="service_report_note_form" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
        ...
        <tbody>
         ...
         <tr>
          ...
          <td> 
            ...
            <button type="button" class="btn btn btn-tbl-edit btn-xs itemEdit" title="Edit" data-toggle="modal" data-target="#myModal" data-id="{{$item->id}}"><i class="fa fa-pencil"></i></button>
      ...
      <div class="dataSearchBox ">
        <form autocomplete="off" action="{{route('reportImageUpload')}}" method="POST" id="img_form"" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
          ...
          <div class="row">
           <div class="col-sm-6">
            <div class="form-group">
              <label for="report_image_file_name">Image</label>
              <div class="p-relative">
