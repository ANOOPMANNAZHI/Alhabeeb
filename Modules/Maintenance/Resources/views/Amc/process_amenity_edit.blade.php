            ...
            <div class="row bb-1 mb-3">
                        ...
                        <div class="col-sm-4">
                          <div class="form-group">
                            ...
                            <div class="p-relative">
                               ...
                               <input  type="date" class="form-control date_ranges" id="amc_schedule_period_from_textt" name="amc_schedule_period_from_textt" value="{{date('Y-m-d',strtotime($amc_schedule_period_from))}}"  placeholder="Enter Start Date">
                           </div>
                       </div>
                   </div>
                   ...
                   <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <div class="p-relative">
                           <i class="fa fa-calendar-o icn-add" aria-hidden="true"></i>
                           <input  type="date" class="form-control date_ranges" id="amc_schedule_period_to_textt" name="amc_schedule_period_to_textt" value="{{date('Y-m-d',strtotime($amc_schedule_period_to))}}"  placeholder="Enter End Date">
                       </div>
                   </div>
               </div>
               <div class="col-sm-4">
                ...
                <button type="button" class="btn btn-primary dataSearchLabel update_amenity">Update</button>
            </div>
        </div>
