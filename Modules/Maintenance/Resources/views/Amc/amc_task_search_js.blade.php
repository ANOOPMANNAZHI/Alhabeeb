...
$(document).ready(function() {
	...
	$(document).on('change keyup paste','.search_fields',function(){ 
	  ...
	  $.ajax({
			  method: "GET",
			  url: '{{url()->current()}}',
			  data:{ 'amcContract__amc_contract_no': amc_schedule_id,'amc_schedule_from_date': amc_schedule_from_date,'amc_schedule_to_date': amc_schedule_to_date,'amenityType__amentity_types_name': amenities_types_id,'vendor__vendor_name': vendor_id,'amc_schedule_task_status': amc_schedule_task_status,'building__building_name': building_id,'paymentMethod__payment_method_code': payment_method_id,'route':'{{url()->current()}}' , 'ajax' : true ,'fieldName' : fieldName , 'operation' : operation , 'fieldValue' : fieldValue , 'logic' : logic },			  
			  beforeSend: function(){
			  ...
			  success: function(data){ 
				...
				var txt = 'amcContract__amc_contract_no='+ amc_schedule_id+'&amc_schedule_from_date='+ amc_schedule_from_date+'&amc_schedule_to_date='+ amc_schedule_to_date+'&amenityType__amentity_types_name='+ amenities_types_id+'&vendor__vendor_name='+ vendor_id+'&amc_schedule_task_status='+ amc_schedule_task_status+'&building__building_name='+ building_id+'&paymentMethod__payment_method_code='+ payment_method_id;			
