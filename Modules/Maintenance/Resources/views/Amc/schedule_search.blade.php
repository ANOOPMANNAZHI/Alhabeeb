   ...
   <div class="panel-body " >
            <div class="dataSearchBox "><!-- @yield('search_url') -->
                    <form autocomplete="off"  action="@yield('search_url')" method="POST" id="leade_search" class="form-horizontal"  da ta-toggle="validator">
                        {{csrf_field()}}
                            <div class="row">
                            ...
                            <input type="hidden"  name="stages" id="stages">
                            <input type="hidden"  name="sales_building_name" id="sales_building_name">
                            <input type="hidden"  name="route" id="route" value="{{Request::fullUrl()}}">
