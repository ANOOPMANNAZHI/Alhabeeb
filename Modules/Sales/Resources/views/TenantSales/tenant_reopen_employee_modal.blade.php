    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col">
                ...
                <form action="{{  route('reOpen')}}" method="POST" id="reassign_modal" class="form-horizontal" enctype="multipart/form-data" data-toggle="validator">
                {{csrf_field()}}
                <input  type="hidden" class="form-control" name="enquiryid" id="enquiryid" value="{{$enquiry_id}}">
                <input  type="hidden" class="form-control" name="workflow_id" id="workflow_id" value="{{$workflow_id}}">
                <input  type="hidden" class="form-control" name="current_stageCode" id="current_stageCode" value="{{$current_stageCode}}">
                <div class="sub-head">Moving To {{$current_stage }} Stage</div>
  ...
  /*if(length == 0){
    ...
    $(document).on('change',".role", function()
    {
     ...
     /* var workflow_id  = $('#workflow_id').val();*/
      var workflow_id  = $('#current_stageCode').val();
