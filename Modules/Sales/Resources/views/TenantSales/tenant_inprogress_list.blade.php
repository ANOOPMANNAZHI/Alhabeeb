...
@section('search_url', route('inprogressList'))
@section('search_reset', route('inprogressList'))
...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">In Progress Enquiry</div>
        </div>
    ...
    <div class="col-md-12 col-sm-12">
        <div class="card  card-box">
                 ...
                 <div class="table-wrap">
                    <div class="table-responsive1">
                            ...
                            <thead>
                               <tr>
                                <th><input type = "checkbox" id = "master" 
                                   ...
                                   <th title="No of prgress days">@sortablelink('inprogress_days','Prog Days',[],[ 'class' => 'sort_url'])</th>
                                   <th>@sortablelink('salesEnquiry.sales_enquiry_name','Customer',[],[ 'class' => 'sort_url'])</th>
                                   <th>@sortablelink('salesEnquiry.sales_mobile_no','Mob',[],[ 'class' => 'sort_url'])</th>
                                   <th>@sortablelink('unit_type','Unit',[],[ 'class' => 'sort_url'])</th>
                                   <th>@sortablelink('loc','Loc',[],[ 'class' => 'sort_url'])</th>
                                   <th>@sortablelink('employee_name','Assigned',[],[ 'class' => 'sort_url'])</th>
                                   <th title="Remark">@sortablelink('sale_note','Last Notes',[],[ 'class' => 'sort_url'])</th>
                                   <th width="18%">Action</th>
                               </tr>
                               <tr>
                                <td></td> 
                                <td>
                                    <input autocomplete="off" type="text" name="sales_enquiry_no" class="search_fields mob" id="sales_enquiry_no" value="{{old('sales_enquiry_no')}}" >
                                </td>
                                <td>
                                    <input autocomplete="off" type="date" name="created_at" class="search_fields mob" id="created_at" value="{{old('created_at')}}" >
                                </td>
                                <td><input autocomplete="off" type="text" name="inprogress_day" class="search_fields mob" id="inprogress_day" value="{{old('inprogress_day')}}" ></td>
                                <td>
                                    <input autocomplete="off" type="text" name="customer_name" class="search_fields" id="sales_enquiry_name" value="{{old('sales_enquiry_name')}}" >
                                </td>
                                <td>
                                    <input autocomplete="off" type="text" name="phone" class="search_fields mob" id="sales_mobile_no"  value="{{old('sales_mobile_no')}}" >
                                </td>
                        ...
                        <tbody id="enquiry-search">
                         ...
                         @include('sales::TenantSales.tenant_inprogress_list_ajax')	
         ...
         <div class="row "  id="pagination">
           ...
           {{$inprogress_lists->appends(\Request::except(['page','_token']))->links()}}
       </div>
       <!-- </form>  -->
   </div>
</div>
