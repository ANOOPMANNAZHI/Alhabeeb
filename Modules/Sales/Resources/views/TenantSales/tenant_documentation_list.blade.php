...
@section('search_reset', route('documentationList'))

@section('content')
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Preliminary Documentation</div>
        </div>
        ...
        <div class="card  card-box">
			...
			<div class="clr"></div></h4>
                        ...
                        <table class="table display product-overview mb-30" id="dtBasicExample">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Duration period">@sortablelink('tenant_contract_duration','Duration (Months)',[],[ 'class' => 'sort_url'])</th>
                                    <th title="Start date">@sortablelink('building_name','Start Dt',[],[ 'class' => 'sort_url'])</th>
                  ...
                  <div class="row "  id="pagination">
                             {{$documntation_lists->appends(\Request::except(['page','_token']))->links()}}
                        </div>
