...
<div class="page-bar">
    <div class="page-title-breadcrumb">
        <div class=" pull-left">
            <div class="page-title">Final Documentation Pending List</div>
        </div>
        {{ Breadcrumbs::render('finalDocPendingApprovalList') }}
    </div>
</div>
                        ...
                        <table class="table display product-overview mb-30" id="dtBasicExample">
                            <thead>
                                <tr>
                                    ...
                                    <th title="Action buttons" width="9%" style="text-align:center">Action</th>
                                </tr>
                                <tr> 
                           ...
                           <tbody id="enquiry-search">
							    ...
							    @include('sales::TenantSales.tenant_final_document_pending_list_ajax')	
							  ...
							  @php 
							           if(!empty($request->customer_name))
										...
										if(!empty($sort)){
											...
											$finalDocumentationLists->appends(['sort' => $sort, 'direction' => $direction ]);
