<div class="modal-dialog assign">
    ...
    <div class="modal-header">
      <h4 class="modal-title">@if($action_key == 'CL') {{'Reject Note'}} @else {{$stage}}  @endif</h4>
   ...
   <div class="row">
    <div class="col">
        ...
        <form action="{{  route('moveNextStage')}}" autocomplete="off" method="POST" id="sales_note_modal" class="form-horizontal sales_note_modal" enctype="multipart/form-data" data-toggle="validator">
        {{csrf_field()}}
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="p-relative">
							...
							<textarea class="form-control"  id="sales_lead_note_name"  placeholder="Enter Note" name="sales_lead_note_name"   data-rule-maxlength="200" data-msg-maxlength="Only allows 200 Characters" required>{{ isset($salesActivity)?  old('sales_lead_note_name',$salesActivity->sales_activities_name): old('sales_lead_note_name')}}</textarea>
                        </div>
                    </div>
                  </div>
