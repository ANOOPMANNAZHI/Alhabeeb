...
<div class="page-bar">
  <div class="page-title-breadcrumb">
    ...
    {{ Breadcrumbs::render('enquiry.show',$enquiry) }}
  </div>
</div>
    ...
    <div class="card card-box salesSearchBox">
      ...
      <div class="dataSearchBox">
        <div class="card-body row">
          ...
          <div class="col-lg-6 p-t-20"> 
            <div class = "txt-full-width">
              <h5 class="details"><b>Activity :  </b><span>{{ $enquiry->sale_enquiry_activity }}</span></h5>
            </div>
          </div>
     ...
     <div class="sub-head">Sales Note</div>
        <div class="dataSearchBox">
        <div class="card-body row">
     ...
     @if(count($allNotes))
     <div class="sub-head">Enquiry Stage Note</div>
      <div class="dataSearchBox">
        <div class="card-body row">
                         <div class="table-responsive1">
                            <table class="table" id="note_datatable">
                                ...
                                <tbody>
                                   ...
                                   @if($note->sales_notes!="")
                                    <tr>
                                        ...
                                        <td>
                                          {{$note->updatedBy->employee->employee_name ?? $note->updatedBy->username}}  </td>
