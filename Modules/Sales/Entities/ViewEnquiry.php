...
class ViewEnquiry extends Model
{
	use Sortable;
	protected $guarded = [];
	protected $table   = 'view_enquiry_list';
   ...
   */
   public function scopeFilter($query, $request){
      ...
      $generalSearch = array();   
        ...
        foreach($request->except(['_token','list_by_week','sort','direction','page','curr_url','fieldValues','ajax','operation','logic','route','fc_att','params','from','to','open_enquiry']) as $key => $val){
